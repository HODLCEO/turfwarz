 ...
 */
export const APP_NAME: string = 'TurfWarZ';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Turf war stle game with chain vs chain action.';
 ...
 */
export const APP_TAGS: string[] = ['Base', 'Hyperliquid', 'Monad', 'Game', 'ChainWarZ', 'Education', 'NFT'];
